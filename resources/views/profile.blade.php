          ...
          <div class="table">
            <div class="row">
              ...
              <div class="col-sm-7">
                ...
                <p>Oasis Outreach Center encourages people to make a statement against teen stereotypes. Help us by creating or sharing your own customized profile photo.</p>@if (isset($user) && Auth::check())<a href="/picture" class="btn btn-main">Create Your Own Picture</a>@if ($user->facebook_user_id == Auth::user()->facebook_user_id)
