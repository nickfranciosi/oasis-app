    ...
    <div id="gallery">
      <section class="gallery-grid">
        <div class="container">
          ...
          <div class="text-center"><a href="/picture" class="btn btn-main">Create Your Own</a>@if (Auth::check())<a href="/profile/{{$user['facebook_user_id']}}" class="btn btn-main">View Your Profile</a>@endif</div>
        </div>
      </section>
